...
<div class="content-section notifications-page farmer-notifications-page buyer-notifications-page">
...
<script id="buyerNotificationsSeed" type="application/json"><?= json_encode([
